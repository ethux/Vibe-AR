    ...
    <main className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="text-center mb-16">
          <div className="w-32 h-32 rounded-full bg-blue-500 mx-auto mb-6 flex items-center justify-center">
            <span className="text-white text-4xl font-bold">JD</span>
          </div>
          <h1 className="text-4xl font-bold mb-4 text-gray-900">John Doe</h1>
        ...
        <section className="bg-white rounded-lg shadow-sm p-8 mb-12">
          ...
          <p className="text-gray-600 mb-4">
            Hello! I'm John Doe, a passionate web developer with over 5 years of experience creating beautiful, functional websites and applications. I specialize in front-end development with React and TypeScript, but I'm also comfortable working with back-end technologies.
          </p>
          <p className="text-gray-600 mb-4">
            When I'm not coding, you can find me hiking, reading science fiction, or experimenting with new recipes in the kitchen. I believe in continuous learning and staying up-to-date with the latest web technologies.
          </p>
        </section>
        ...
        {/* Projects Section */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold mb-6 text-gray-900">Featured Projects</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="h-48 bg-blue-100"></div>
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2">E-commerce Platform</h3>
                <p className="text-gray-600 mb-4">A full-featured online store with shopping cart, payment processing, and user accounts.</p>
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">A productivity application for managing tasks, projects, and team collaboration.</p>
                <div className="flex space-x-2">
        ...
        <section className="bg-white rounded-lg shadow-sm p-8">
          ...
          <form className="space-y-4">
            ...
            <div>
              ...
              <input type="email" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="your@email.com"/>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Message</label>
              <textarea rows={4} className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Your message"></textarea>
            </div>
