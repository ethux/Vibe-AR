...
import { log } from './modules/core/logging.js';
import { getXrSession, setXrSession, getTermWs } from './modules/core/state.js';
import { setStatus } from './modules/core/logging.js';
import { initTerminal } from './modules/terminal.js';
import { initScene } from './modules/scene.js';
import { startARSession } from './modules/ar-session.js';
import { startRecording, stopRecording, getIsRecording } from './modules/input/voice.js';
...
(async () => {
  try {
    ...
    // Make overlay transparent so 3D scene is visible in browser
    const overlay = document.getElementById('overlay');
    if (overlay) overlay.classList.add('transparent');
